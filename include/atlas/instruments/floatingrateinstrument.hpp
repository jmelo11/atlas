...
#ifndef D87C18C7_F823_499C_AFAE_F1FE84BEBA22
#define D87C18C7_F823_499C_AFAE_F1FE84BEBA22
...
namespace Atlas {
    ...
    class FloatingRateInstrument : public SigleLegInstrument {
       public:
        FloatingRateInstrument(double spread) : spread_(spread){};

        const RateIndex& index() { return leg_.metaData().index_; }

        double spread() const { return spread_; }
        void spread(double s) { spread_ = s; }
...
#endif /* D87C18C7_F823_499C_AFAE_F1FE84BEBA22 */
