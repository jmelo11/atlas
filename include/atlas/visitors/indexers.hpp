...
#ifndef DA020EEB_4524_41BD_A739_1F071439DAEB
#define DA020EEB_4524_41BD_A739_1F071439DAEB
...
namespace Atlas {
    ...
    class DFIndexer : public Visitor {
       public:
        DFIndexer(){};
        void visit(DAP& inst) override { addDFs(inst.leg()); };
        void visit(FixedBullet& inst) override { addDFs(inst.leg()); }
        void visit(EqualPayment& inst) override { addDFs(inst.leg()); }
        void visit(FloatingBullet& inst) override { addDFs(inst.leg()); }

        void visit(FloatingCustomStructure& inst) override { addDFs(inst.leg()); }

        void visit(FixedCustomStructure& inst) override { addDFs(inst.leg()); }
        ...
        void setRequest(MarketRequest& request) { request.dfs.insert(request.dfs.end(), dfs_.begin(), dfs_.end()); }

        void clear() { dfs_.clear(); }
    ...
    class ForwardRatendexer : public Visitor {
       public:
        void visit(FloatingBullet& inst) override { addFwds(inst.leg()); }
        ...
        void visit(FloatingCustomStructure& inst) override { addFwds(inst.leg()); };

        void visit(FixFloatSwap& inst) override { addFwds(inst.legs()[1]); }

        void setRequest(MarketRequest& request) { request.fwds.insert(request.fwds.end(), fwds_.begin(), fwds_.end()); };

        void clear() { fwds_.clear(); }
    ...
    class ForwardAndDiscountIndexer : public Visitor {
       public:
        void visit(DAP& inst) override { addFwdsAndDfs(inst.leg(), false); };

        void visit(EqualPayment& inst) override { addFwdsAndDfs(inst.leg(), false); };

        void visit(FixedBullet& inst) override { addFwdsAndDfs(inst.leg(), false); };

        void visit(FixedCustomStructure& inst) override { addFwdsAndDfs(inst.leg(), false); };
        void visit(FloatingBullet& inst) override { addFwdsAndDfs(inst.leg(), true); }
        void visit(FloatingCustomStructure& inst) override { addFwdsAndDfs(inst.leg(), true); };
...
#endif /* DA020EEB_4524_41BD_A739_1F071439DAEB */
