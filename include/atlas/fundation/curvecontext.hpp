...
namespace Atlas {
    ...
    class CurveContext {
       public:
        ...
        inline const Index<adouble>& index() const { return index_; }
       ...
       private:
        CurveContext(size_t idx, const std::string& name, const YieldTermStructure<adouble>& curve, const Index<adouble>& index,
