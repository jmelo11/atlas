...
struct TestSetup {
    ...
    void createInstruments() {
        ...
        atlasFloatBond           = new FloatingRateBulletInstrument<adouble>(startDate, endDate, paymentFrequency, notional, spread,
                                                                   curveManager.curveContext("TEST").index(), curveManager.curveContext("TEST").idx(),
                                                                   curveManager.curveContext("TEST").idx());
    }
};
